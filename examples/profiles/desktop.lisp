...
(ekko/extensions:register-component :id :desktop-windows :reads '(:focus :mode :panes)
...
(ekko/extensions:register-component :id :desktop-dock :reads '(:session :viewport :focus :panes :mode)
