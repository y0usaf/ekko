...
(ekko/extensions:register-component :id :desktop-windows :reads '(:focus :mode :panes :zoom :component-state)
...
(ekko/extensions:register-component :id :desktop-dock :reads '(:session :viewport :focus :panes :mode :zoom)
